// Durand Tech Systen - Widget Chat Juliana v3 - Orçamento em nova página
window.abrirOrcamentoNovaPagina = function(tipo=''){
  const url = tipo ? 'orcamento.html?tipo=' + encodeURIComponent(tipo) : 'orcamento.html';
...
(function(){
  ...
  async function sendMessage(){
    ...
    try {
      ...
      if(data.action === 'whatsapp_juliana'){ window.open(`https://wa.me/${CONFIG.WHATSAPP_JULIANA}?text=` + encodeURIComponent(text), '_blank', 'noopener'); }
